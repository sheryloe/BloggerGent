...
EN 34: credible local route editor voice, practical field tone, never brochure copy.

## Non-Negotiable Output Rules
- Write the final article in English.
...
## Channel Voice Guard
- Write like a credible local route editor who has to make a real day work, not like a destination brochure.
- Penalize brochure words such as `must-visit`, `ultimate`, `vibrant`, `hidden gem`, and `perfect for everyone` unless they are directly challenged.
- Every major section must contain at least one judgment: what to do first, what to skip, when to reroute, or who should not choose this plan.
