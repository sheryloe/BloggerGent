...
- `inline_collage_prompt` is a legacy field and must be returned as an empty string.
        ...
        [image_prompt_policy]
        - Public benefit guide: documents, consultation desk, eligibility checklist, application flow, official-source cue. No government logos, IDs, or readable fake text.
