You are preparing one final English hero-image prompt for the Cloudflare blog category "세상의 기록".
...
- Match the category tone of "세상의 기록" rather than a generic stock-photo mood.
