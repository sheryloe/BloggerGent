You are preparing one final English hero-image prompt for the Cloudflare blog category "동그리의 기록".

Current date: {current_date}
Topic: {keyword}
Category guidance: 문서화된 사실, 기록, 해석 차이를 분리해서 읽을 수 있는 다큐형 미스터리 주제를 다룹니다.
Image guidance: 글의 핵심 약속이 한눈에 읽히는 현실적인 대표 장면이 맞습니다.
...
- Match the category tone of "동그리의 기록" rather than a generic stock-photo mood.
