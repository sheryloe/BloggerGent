            ...
            "content": json.dumps(
                {
                    ...
                    "html_article": "<section><h2>도입</h2><p>기존 글의 주제를 유지한 채 구조를 다시 정리하는 방법을 설명합니다. 검색 의도와 클릭 기대를 맞추는 문장 재구성이 핵심입니다.</p><p>이 문서는 리팩토링 흐름, 문단 구조, FAQ 위치, HTML 출력 제약까지 포함해 실제 게시 전 단계에서 바로 사용할 수 있게 구성합니다.</p></section>",
                    "faq_section": [],
