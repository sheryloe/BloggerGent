    ...
    try:
        ...
        with httpx.Client(follow_redirects=True, timeout=15.0) as http_client:
            for payload in remote_posts:
                ...
                post.live_unique_image_count = audit.live_unique_image_count
                post.live_duplicate_image_count = audit.live_duplicate_image_count
                post.live_webp_count = audit.live_webp_count
                post.live_png_count = audit.live_png_count
                post.live_other_image_count = audit.live_other_image_count
