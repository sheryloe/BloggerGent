...
def _build_cloudflare_rows(db: Session) -> tuple[list[list[str]], int]:
    from app.services.cloudflare.cloudflare_channel_service import list_cloudflare_posts
    from app.services.content.content_ops_service import compute_dbs_score, compute_seo_geo_scores, compute_similarity_analysis
