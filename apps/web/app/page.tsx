...
export const metadata: Metadata = {
  ...
  title: "Donggr AutoBloggent | Multi-Platform Marketing OS",
  description:
    "Donggr AutoBloggent는 생성·자산·업로드·운영 루프를 통합해 Blogger, YouTube, Instagram 운영을 자동화하는 멀티 플랫폼 마케팅 운영 시스템입니다.",
  alternates: {
    canonical: "/",
  },
  openGraph: {
    ...
    locale: "ko_KR",
    siteName: "Donggr AutoBloggent",
    images: [
      {
        url: "/marketing/dashboard-main.png",
        width: 1280,
        height: 720,
        alt: "Donggr AutoBloggent Dashboard Mission Control",
      },
    ],
  },
  twitter: {
    ...
    title: "Donggr AutoBloggent | Multi-Platform Marketing OS",
    description:
      "Blogger, YouTube, Instagram을 SEO/CTR 피드백 루프로 운영하는 멀티 플랫폼 마케팅 운영 시스템.",
...
const softwareApplicationJsonLd = {
  ...
  name: "Donggr AutoBloggent",
  applicationCategory: "BusinessApplication",
  operatingSystem: "Web, Docker, WSL",
  description:
    "개인 운영자를 위한 멀티 플랫폼 마케팅 운영 시스템. 콘텐츠 생성, 게시, 분석, SEO/CTR 개선 루프를 통합 제공합니다.",
  offers: {
    "@type": "Offer",
    price: "0",
    priceCurrency: "USD",
...
const faqJsonLd = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "Donggr AutoBloggent는 무엇을 자동화하나요?",
      acceptedAnswer: {
        "@type": "Answer",
