...
export default function ArticlesPage({
  ...
  if (isStaticPreview) {
    return <div className="rounded-[28px] border border-slate-200 bg-white p-6 text-sm text-slate-500 shadow-sm">GitHub Pages 프리뷰에서는 콘텐츠 운영 화면에서 글 보관 탭을 확인하세요.</div>;
  }
